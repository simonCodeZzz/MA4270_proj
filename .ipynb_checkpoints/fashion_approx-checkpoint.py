...
X_fashion = fashion.iloc[:,1:].values
y_fashion = fashion.iloc[:,0].values
sample_size = 10000
X = X_fashion.copy()[:sample_size,:]
...
np.save("data/Ds_fashion.npy", Ds)
np.save("data/rbf_mse_fashion.npy", rbf_mse)
np.save("data/laplace_mse_fashion.npy", laplace_mse)
np.save("data/rbf_time_fashion.npy", rbf_time)
np.save("data/laplace_time_fashion.npy", laplace_time)
print("Successfully saved: fashion")
